(function(window){
    ...
    if(window.performance && window.performance.timing) {
        ...
        document.getElementById("time-to-first-byte").innerHTML = "Navigation Timing API is not supported in this browser";
        document.getElementById("time-to-dom-loading").innerHTML = "Navigation Timing API is not supported in this browser"
    }
})(window);